...
class BackupManager @Inject constructor(
    ...
    private fun FundEntity.toJson() = JSONObject().apply { put("id", id); put("name", name); put("icon", icon); put("colorHex", colorHex); put("sourceName", sourceName); put("startingBalance", startingBalance); put("minimumBalance", minimumBalance); put("createdAt", createdAt); put("updatedAt", updatedAt) }
    ...
    private fun fundFromJson(o: JSONObject) = FundEntity(o.string("id"), o.string("name"), o.string("icon"), o.string("colorHex"), o.string("sourceName"), o.optDouble("startingBalance"), o.optDouble("minimumBalance", -1.0), o.optLong("createdAt"), o.optLong("updatedAt"))
